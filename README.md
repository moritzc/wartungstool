...
- Das Skript muss für den vollen Funktionsumfang als **Administrator** ausgeführt werden. Es enthält eine Abfrage zur Rechteerweiterung, falls es nicht als Administrator gestartet wird. Bei Ablehnung führen manche Abfragen zu Fehlermeldungen.
